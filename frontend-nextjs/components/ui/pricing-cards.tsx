...
const Pricing2 = ({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative container z-10 pt-16">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 text-center">
          ...
          <div className="mt-8 flex flex-col items-stretch gap-6 md:flex-row justify-center">
            {plans.map((plan, i) => (
              <Card
                key={plan.id}
                className={`card-animate flex w-full md:w-80 flex-col justify-between text-left border-zinc-800 bg-zinc-900/70 backdrop-blur supports-[backdrop-filter]:bg-zinc-900/60 ${
              ...
              >
                <CardHeader>
                  ...
                  <span className="text-4xl font-bold text-white mt-4 inline-block">
                ...
                <CardContent className="flex-1">
                  ...
                  <ul className="space-y-4">
                    {plan.features.map((feature, index) => (
                      <li key={index} className="flex items-center gap-3 text-zinc-200 text-sm">
                ...
                <CardFooter className="mt-auto pt-6">
                  <Button
                    asChild
                    className="w-full rounded-lg bg-zinc-100 text-zinc-900 hover:bg-zinc-200 h-11"
                  >
